<!-- Component shows the Patiens of a respective User -->
<template>
  <div>
...
export default {
  ...
  //Method to filter Patients by Username or ID 
  computed:{
  ...
  methods:{
    ...
    // Methods to create Charts for Bloodpressure, Glucose Values, Resprate ...
